...
class AE_3D_300(nn.Module):
    def __init__(self, n_features=4):
        super(AE_3D_300, self).__init__()
        self.en1 = nn.Linear(n_features, 300)
        self.en2 = nn.Linear(300, 150)
        self.en3 = nn.Linear(150, 75)
        self.en4 = nn.Linear(75, 25)
        self.en5 = nn.Linear(25,3)
        self.de1 = nn.Linear(3,25)
        self.de2 = nn.Linear(25,75)
        self.de3 = nn.Linear(75,150)
        self.de4 = nn.Linear(150,300)
        self.de5 = nn.Linear(300, n_features)
        self.leakyrelu = nn.LeakyReLU

    def encode(self, x):
        return self.en5(self.leakyrelu(self.en4(self.leakyrelu(self.en3(self.leakyrelu(self.en2(self.leakyrelu(self.en1(x)))))))))

    def decode(self, x):
        return self.de5(self.leakyrelu(self.de4(self.leakyrelu(self.de3(self.leakyrelu(self.de2(self.leakyrelu(self.leakyrelu(self.de1(x))))))))))
    ...
    def describe(self):
        return 'in-300-150-75-25-3-25-75-150-300-out'
